    ...
    <div className="relative h-full w-full">
      ...
      <div className="absolute top-4 left-1/2 -translate-x-1/2 z-[1000]">
        <button
          ...
          className="px-5 py-3 rounded-2xl bg-orange-600/90 backdrop-blur-sm text-white text-center shadow-lg hover:bg-orange-700 hover:scale-105 transition-all duration-200"
        >
      ...
      <div className="absolute top-4 right-4 z-[1000] sm:top-5 sm:right-6">
        <a
          href={instagramUrl}
          target="_blank"
